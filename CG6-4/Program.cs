...
namespace CG6_4
{
    class Program
    {
        ...
        {
            //Create a program that counts the number of days between two different
            //dates both input by the user. 
            //Upload your program to a new repository called CG 6 - 4.
